...
_Analyzing Retail and Warehouse Sales to support data-driven business decisions using Python and Power BI_
...
**Dataset Name:** Retail_and_Warehouse_Sales  
**Format:** Excel (.csv)
...
```text
retail-and-warehouse-sales-python-powerbi/
├── README.md
├── requirements.txt
├── data/
